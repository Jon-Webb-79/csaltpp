...
static inline uint8_t _ssse3_hmin_u8(__m128i v) {
...
static inline uint8_t _ssse3_hmax_u8(__m128i v) {
...
static size_t simd_min_uint8(const uint8_t* data,
    ...
    if (data_size == 1u) {
        ...
        uint8_t min_val = _ssse3_hmin_u8(vmin);
...
static size_t simd_max_uint8(const uint8_t* data,
    ...
    if (data_size == 1u) {
        ...
        uint8_t max_val = _ssse3_hmax_u8(vmax);
        for (size_t j = 0u; j < len; j++)
